...
<form action=GMService_queryRoleComsumption_response.jsp method=post>
<table align=center border cellpadding=2>
<tr><th colspan=2 align=center><%=LocaleUtil2.getMessage(request,"GMService_queryRoleComsumption_title")%></th></tr>
<tr><th align=center>Argument</th><th>Comment</th></tr>
<tr><td align=center>roleid:<input type=text name=GMService_queryRoleComsumption_roleid></td><td align=center></td></tr>
