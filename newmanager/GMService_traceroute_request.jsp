...
<form action=GMService_traceroute_response.jsp method=post>
<table align=center border cellpadding=2>
<tr><th colspan=2 align=center><%=LocaleUtil2.getMessage(request,"GMService_traceroute_title")%></th></tr>
<tr><th align=center>Argument</th><th>Comment</th></tr>
<tr><td align=center>host ip:<input type=text name=GMService_traceroute_host></td><td align=center></td></tr>
