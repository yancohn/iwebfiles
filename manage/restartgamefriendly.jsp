...
<title><%= LocaleUtil.getMessage(request,"manage_ref_title") %></title>
</head>
...
<%
	if( success )
		out.print( LocaleUtil.getMessage(request,"manage_ref_ok") + "&nbsp;&nbsp;&nbsp;&nbsp;" );
	else
		out.print( LocaleUtil.getMessage(request,"manage_ref_fail") + "&nbsp;&nbsp;&nbsp;&nbsp;" );
%>
    </td>
  </tr>
</table>
