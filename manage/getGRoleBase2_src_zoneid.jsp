...
<%
			...
			LogFactory.getLog("getGRoleBase2_src_zoneid.jsp").info(
	...
	<body>
		...
		<table width="100%" height="514" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			...
			if (roleid != null && roleid.trim().length() > 0) {
				...
				info = new LogInfo(rid, "", "getGRoleBase2_src_zoneid");
			...
			<tr>
				<td align="center">
					<form name="form1" action="getGRoleBase2_src_zoneid.jsp" method="post">
						<table>
							<tr>
								<td>
