...
public final class FactionClientManager extends Manager
{
    ...
    FactionClientManager() { conn_state = false; backoff = BACKOFF_INIT; }
    ...
    synchronized protected void OnAddSession(Session session)
    {
		synchronized (locker_state){
            ...
            System.out.println( "OnAddSession " + session );
            notify();
    }
	...
	protected void OnDelSession(Session session)
    {
        ...
        System.out.println( "OnDelSession " + session );
        s = null;
    }
    ...
    protected void OnAbortSession(Session session)
    {
        ...
        System.out.println( "OnAbortSession " + session );
        s = null;
    }
