...
<%
			...
			LogFactory.getLog("clearallmoney.jsp").info(
	...
	<body>
		...
		<table width="100%" height="514" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			...
			if (roleid != null && roleid.trim().length() > 0) {
				...
				info = new LogInfo(rid, "", "clearallmoney");
				long flag = -1;
				flag = gs.modifyRoleClearAllMoney(rid, info);
			...
			<tr>
				<td align="center">
					<form name="form1" action="clearallmoney.jsp" method="post">
						<table>
							<tr>
								<td>
